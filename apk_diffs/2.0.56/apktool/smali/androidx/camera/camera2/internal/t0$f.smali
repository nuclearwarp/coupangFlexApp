.class Landroidx/camera/camera2/internal/t0$f;
...
.method static constructor <clinit>()V
    ...
    .line 9
    sput-wide v0, Landroidx/camera/camera2/internal/t0$f;->e:J
...
.method constructor <init>(Landroidx/camera/camera2/internal/u;ILjava/util/concurrent/Executor;)V
    ...
    .line 5
    iput-boolean v0, p0, Landroidx/camera/camera2/internal/t0$f;->c:Z

    .line 6
    .line 7
    iput-object p1, p0, Landroidx/camera/camera2/internal/t0$f;->a:Landroidx/camera/camera2/internal/u;

    .line 8
    .line 9
    iput p2, p0, Landroidx/camera/camera2/internal/t0$f;->b:I

    .line 10
    .line 11
    iput-object p3, p0, Landroidx/camera/camera2/internal/t0$f;->d:Ljava/util/concurrent/Executor;
...
.method public static synthetic d(Landroidx/camera/camera2/internal/t0$f;Ljava/lang/Void;)Lcom/google/common/util/concurrent/f;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/t0$f;->j(Ljava/lang/Void;)Lcom/google/common/util/concurrent/f;
...
.method public static synthetic e(Landroidx/camera/camera2/internal/t0$f;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)Ljava/lang/Object;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/t0$f;->h(Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)Ljava/lang/Object;
...
.method public static synthetic f(Landroid/hardware/camera2/TotalCaptureResult;)Ljava/lang/Boolean;
    ...
    .line 1
    invoke-static {p0}, Landroidx/camera/camera2/internal/t0$f;->k(Landroid/hardware/camera2/TotalCaptureResult;)Ljava/lang/Boolean;
...
.method public static synthetic g(Landroid/hardware/camera2/TotalCaptureResult;)Z
    ...
    .line 1
    invoke-static {p0}, Landroidx/camera/camera2/internal/t0$f;->i(Landroid/hardware/camera2/TotalCaptureResult;)Z
...
.method private synthetic h(Landroidx/concurrent/futures/CallbackToFutureAdapter$a;)Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Landroidx/camera/camera2/internal/t0$f;->a:Landroidx/camera/camera2/internal/u;

    .line 2
    .line 3
    invoke-virtual {v0}, Landroidx/camera/camera2/internal/u;->N()Landroidx/camera/camera2/internal/d4;
    ...
    .line 8
    invoke-virtual {v0, p1, v1}, Landroidx/camera/camera2/internal/d4;->e(Landroidx/concurrent/futures/CallbackToFutureAdapter$a;Z)V
...
.method private synthetic j(Ljava/lang/Void;)Lcom/google/common/util/concurrent/f;
    ...
    .line 1
    sget-wide v0, Landroidx/camera/camera2/internal/t0$f;->e:J

    .line 2
    .line 3
    iget-object p1, p0, Landroidx/camera/camera2/internal/t0$f;->a:Landroidx/camera/camera2/internal/u;
...
.method public a(Landroid/hardware/camera2/TotalCaptureResult;)Lcom/google/common/util/concurrent/f;
    ...
    .line 1
    iget v0, p0, Landroidx/camera/camera2/internal/t0$f;->b:I
    ...
    .line 31
    iput-boolean p1, p0, Landroidx/camera/camera2/internal/t0$f;->c:Z
    ...
    .line 34
    .line 35
    invoke-direct {p1, p0}, Landroidx/camera/camera2/internal/d1;-><init>(Landroidx/camera/camera2/internal/t0$f;)V
    ...
    .line 47
    .line 48
    invoke-direct {v0, p0}, Landroidx/camera/camera2/internal/e1;-><init>(Landroidx/camera/camera2/internal/t0$f;)V

    .line 49
    .line 50
    .line 51
    iget-object v1, p0, Landroidx/camera/camera2/internal/t0$f;->d:Ljava/util/concurrent/Executor;
...
.method public c()V
    ...
    .line 1
    iget-boolean v0, p0, Landroidx/camera/camera2/internal/t0$f;->c:Z
    ...
    .line 13
    invoke-virtual {v0, v1, v2}, Landroidx/camera/camera2/internal/d4;->e(Landroidx/concurrent/futures/CallbackToFutureAdapter$a;Z)V
