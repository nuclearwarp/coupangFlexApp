...
.method private collectLogCat(Lmm/f;Ljava/lang/String;)Ljava/lang/String;
    .locals 6
    .param p1    # Lmm/f;
    ...
    .line 24
    :cond_0
    invoke-virtual {p1}, Lmm/f;->q()Llm/b;
    ...
    .line 112
    invoke-interface {v1, v2, p2}, Lpm/a;->c(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 120
    invoke-direct {p0, p1, p2, v1, v4}, Lorg/acra/collector/LogCatCollector;->streamToString(Lmm/f;Ljava/io/InputStream;Lwm/h;I)Ljava/lang/String;
...
.method private streamToString(Lmm/f;Ljava/io/InputStream;Lwm/h;I)Ljava/lang/String;
    .locals 1
    .param p1    # Lmm/f;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 2
    .line 3
    invoke-direct {v0, p2}, Lwm/j;-><init>(Ljava/io/InputStream;)V

    .line 4
    .line 5
    .line 6
    invoke-virtual {v0, p3}, Lwm/j;->e(Lwm/h;)Lwm/j;
    ...
    .line 10
    invoke-virtual {p2, p4}, Lwm/j;->f(I)Lwm/j;
    ...
    .line 21
    .line 22
    invoke-virtual {p2, p1}, Lwm/j;->g(I)Lwm/j;

    .line 23
    .line 24
    .line 25
    :cond_0
    invoke-virtual {p2}, Lwm/j;->b()Ljava/lang/String;
...
.method collect(Lorg/acra/ReportField;Landroid/content/Context;Lmm/f;Lkm/b;Lorg/acra/data/a;)V
    ...
    :cond_2
    :goto_0
    invoke-direct {p0, p3, v0}, Lorg/acra/collector/LogCatCollector;->collectLogCat(Lmm/f;Ljava/lang/String;)Ljava/lang/String;
