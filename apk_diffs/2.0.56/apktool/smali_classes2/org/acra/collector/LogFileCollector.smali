...
.method collect(Lorg/acra/ReportField;Landroid/content/Context;Lmm/f;Lkm/b;Lorg/acra/data/a;)V
    ...
    .line 2
    .line 3
    new-instance p4, Lwm/j;

    .line 4
    .line 5
    invoke-virtual {p3}, Lmm/f;->f()Lorg/acra/file/Directory;
    ...
    .line 9
    invoke-virtual {p3}, Lmm/f;->e()Ljava/lang/String;
    ...
    .line 17
    invoke-direct {p4, p2}, Lwm/j;-><init>(Ljava/io/File;)V

    .line 18
    .line 19
    .line 20
    invoke-virtual {p3}, Lmm/f;->g()I
    ...
    .line 24
    invoke-virtual {p4, p2}, Lwm/j;->f(I)Lwm/j;
