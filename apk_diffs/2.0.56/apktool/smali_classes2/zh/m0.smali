...
.method public static i()Ljava/util/Map;
    ...
    .line 1
    sget-object v0, Lzh/b0;->i:Lzh/b0;
...
.method public static j(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 5
    .line 6
    invoke-static {p0, p1}, Lzh/k0;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs k([Lxh/m;)Ljava/util/HashMap;
    .locals 2
    .param p0    # [Lxh/m;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 15
    .line 16
    invoke-static {v0, p0}, Lzh/m0;->q(Ljava/util/Map;[Lxh/m;)V
...
.method public static varargs l([Lxh/m;)Ljava/util/Map;
    .locals 2
    .param p0    # [Lxh/m;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 18
    .line 19
    invoke-static {p0, v0}, Lzh/m0;->u([Lxh/m;Ljava/util/Map;)Ljava/util/Map;
...
.method public static varargs m([Lxh/m;)Ljava/util/Map;
    .locals 2
    .param p0    # [Lxh/m;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static final n(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 16
    :cond_0
    invoke-static {p0}, Lzh/l0;->g(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final q(Ljava/util/Map;[Lxh/m;)V
    .locals 4
    .param p0    # Ljava/util/Map;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static r(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    .line 34
    .line 35
    invoke-static {p0, v1}, Lzh/m0;->s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 61
    .line 62
    invoke-static {p0}, Lzh/j0;->f(Lxh/m;)Ljava/util/Map;
    ...
    .line 76
    .line 77
    invoke-static {p0, v0}, Lzh/m0;->s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 81
    invoke-static {p0}, Lzh/m0;->n(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 10
    .line 11
    invoke-static {p1, p0}, Lzh/m0;->p(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static t(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 14
    .line 15
    invoke-static {p0}, Lzh/j0;->v(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final u([Lxh/m;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    .param p0    # [Lxh/m;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 10
    .line 11
    invoke-static {p1, p0}, Lzh/m0;->q(Ljava/util/Map;[Lxh/m;)V
