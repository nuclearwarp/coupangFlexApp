...
.method private L(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/g;
    ...
    invoke-direct {v0, v1, v3}, Lj$/time/chrono/g;->P(Lj$/time/temporal/m;Lj$/time/l;)Lj$/time/chrono/g;
    ...
    invoke-interface {v1, v10, v11, v2}, Lj$/time/chrono/b;->k(JLj$/time/temporal/u;)Lj$/time/chrono/b;
...
.method private P(Lj$/time/temporal/m;Lj$/time/l;)Lj$/time/chrono/g;
    .locals 2
...
.method static o(Lj$/time/chrono/m;Lj$/time/temporal/m;)Lj$/time/chrono/g;
    .locals 3
...
.method static x(Lj$/time/chrono/b;Lj$/time/l;)Lj$/time/chrono/g;
    .locals 1
...
.method public final B(JLj$/time/temporal/u;)Lj$/time/chrono/g;
    ...
    invoke-interface {v2, v8, v9, v0}, Lj$/time/chrono/b;->k(JLj$/time/temporal/u;)Lj$/time/chrono/b;

    move-result-object v0

    invoke-direct {v10, v0, v3}, Lj$/time/chrono/g;->P(Lj$/time/temporal/m;Lj$/time/l;)Lj$/time/chrono/g;
    ...
    invoke-interface {v2, v4, v5, v6}, Lj$/time/chrono/b;->k(JLj$/time/temporal/u;)Lj$/time/chrono/b;

    move-result-object v2

    invoke-direct {v10, v2, v3}, Lj$/time/chrono/g;->P(Lj$/time/temporal/m;Lj$/time/l;)Lj$/time/chrono/g;
    ...
    invoke-direct/range {v11 .. v20}, Lj$/time/chrono/g;->L(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/g;
    ...
    .line 0
    :cond_0
    invoke-interface {v2}, Lj$/time/chrono/b;->f()Lj$/time/chrono/m;
    ...
    invoke-static {v1, v0}, Lj$/time/chrono/g;->o(Lj$/time/chrono/m;Lj$/time/temporal/m;)Lj$/time/chrono/g;
...
.method public final D(Lj$/time/ZoneOffset;)Lj$/time/chrono/j;
    ...
    .line 0
    invoke-static {p1, v0, p0}, Lj$/time/chrono/l;->x(Lj$/time/y;Lj$/time/ZoneOffset;Lj$/time/chrono/g;)Lj$/time/chrono/j;
...
.method public final O(JLj$/time/temporal/q;)Lj$/time/chrono/g;
    ...
    invoke-virtual {v2, p1, p2, p3}, Lj$/time/l;->b0(JLj$/time/temporal/q;)Lj$/time/l;

    move-result-object p1

    invoke-direct {p0, v1, p1}, Lj$/time/chrono/g;->P(Lj$/time/temporal/m;Lj$/time/l;)Lj$/time/chrono/g;
    ...
    :cond_0
    invoke-interface {v1, p1, p2, p3}, Lj$/time/chrono/b;->i(JLj$/time/temporal/q;)Lj$/time/chrono/b;

    move-result-object p1

    invoke-direct {p0, p1, v2}, Lj$/time/chrono/g;->P(Lj$/time/temporal/m;Lj$/time/l;)Lj$/time/chrono/g;
...
.method public final h(Lj$/time/temporal/q;)I
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lj$/time/chrono/g;->g(Lj$/time/temporal/q;)Lj$/time/temporal/w;
...
.method public final j(Lj$/time/i;)Lj$/time/temporal/m;
    ...
    invoke-direct {p0, p1, v0}, Lj$/time/chrono/g;->P(Lj$/time/temporal/m;Lj$/time/l;)Lj$/time/chrono/g;
