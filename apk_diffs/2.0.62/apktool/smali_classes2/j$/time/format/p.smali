...
.method constructor <init>(Lj$/time/temporal/n;Lj$/time/format/DateTimeFormatter;)V
    ...
    invoke-virtual {p2}, Lj$/time/format/DateTimeFormatter;->e()Lj$/time/y;
    ...
    invoke-interface {p1, v2}, Lj$/time/temporal/n;->b(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v3}, Lj$/time/temporal/n;->b(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/n;->d(Lj$/time/temporal/q;)Z
    ...
    :cond_6
    :try_start_0
    invoke-interface {p1, v6}, Lj$/time/temporal/n;->e(Lj$/time/temporal/q;)J
    ...
    invoke-static {v2, v3, v5, v6}, Lj$/time/Instant;->O(JJ)Lj$/time/Instant;
    ...
    .line 0
    :goto_2
    invoke-interface {v4, p1, v1}, Lj$/time/chrono/m;->u(Lj$/time/Instant;Lj$/time/y;)Lj$/time/chrono/j;
    ...
    :cond_7
    :try_start_1
    invoke-virtual {v1}, Lj$/time/y;->o()Lj$/time/zone/f;
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/n;->h(Lj$/time/temporal/q;)I
    ...
    invoke-interface {p1, v1}, Lj$/time/temporal/n;->d(Lj$/time/temporal/q;)Z

    move-result v1

    if-eqz v1, :cond_c

    invoke-interface {v4, p1}, Lj$/time/chrono/m;->q(Lj$/time/temporal/n;)Lj$/time/chrono/b;
    ...
    invoke-direct {v0, v5, p1, v4, v3}, Lj$/time/format/o;-><init>(Lj$/time/chrono/b;Lj$/time/temporal/n;Lj$/time/chrono/m;Lj$/time/y;)V
