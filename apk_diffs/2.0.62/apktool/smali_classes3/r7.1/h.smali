...
.method public static synthetic b(Landroid/graphics/Bitmap;Lio/flutter/plugin/common/MethodChannel$Result;I)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2}, Lr7/h;->o(Landroid/graphics/Bitmap;Lio/flutter/plugin/common/MethodChannel$Result;I)V
...
.method public static synthetic c(Lio/flutter/plugin/common/MethodChannel$Result;I)V
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lr7/h;->n(Lio/flutter/plugin/common/MethodChannel$Result;I)V
...
.method public static synthetic d(Lio/flutter/plugin/common/MethodChannel$Result;Ljava/io/ByteArrayOutputStream;)V
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lr7/h;->m(Lio/flutter/plugin/common/MethodChannel$Result;Ljava/io/ByteArrayOutputStream;)V
...
.method public static synthetic e(ZLio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;Landroid/os/Handler;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3, p4}, Lr7/h;->r(ZLio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;Landroid/os/Handler;Landroid/os/Handler;)V
...
.method public static synthetic f(ZLio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;Landroid/os/Handler;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3, p4}, Lr7/h;->q(ZLio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;Landroid/os/Handler;Landroid/os/Handler;)V
...
.method static g(Landroid/app/Activity;Lio/flutter/plugin/common/MethodChannel;Lio/flutter/plugin/common/MethodChannel$Result;)V
    ...
    .line 1
    invoke-static {p0}, Lr7/h;->k(Landroid/app/Activity;)Lio/flutter/embedding/android/FlutterView;
    ...
    .line 30
    .line 31
    sget-object p1, Lr7/h;->b:Landroid/os/Handler;
    ...
    .line 53
    .line 54
    sput-object v0, Lr7/h;->b:Landroid/os/Handler;

    .line 55
    .line 56
    :cond_2
    sget-object p1, Lr7/h;->c:Landroid/os/Handler;
    ...
    .line 68
    .line 69
    sput-object p1, Lr7/h;->c:Landroid/os/Handler;
    ...
    .line 72
    .line 73
    sget-object v0, Lr7/h;->c:Landroid/os/Handler;

    .line 74
    .line 75
    invoke-static {p1, v0, p0, p2}, Lr7/h;->t(Landroid/os/Handler;Landroid/os/Handler;Lio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;)V
...
.method private static j(Lio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;Landroid/os/Handler;)V
    ...
    .line 101
    .line 102
    invoke-direct {v1, v0, p1}, Lr7/e;-><init>(Landroid/graphics/Bitmap;Lio/flutter/plugin/common/MethodChannel$Result;)V

    .line 103
    .line 104
    .line 105
    invoke-static {p0, v3, v0, v1, p2}, Lr7/a;->a(Landroid/view/Window;Landroid/graphics/Rect;Landroid/graphics/Bitmap;Landroid/view/PixelCopy$OnPixelCopyFinishedListener;Landroid/os/Handler;)V
...
.method private static synthetic o(Landroid/graphics/Bitmap;Lio/flutter/plugin/common/MethodChannel$Result;I)V
    ...
    .line 25
    .line 26
    invoke-direct {p0, p1, p2}, Lr7/f;-><init>(Lio/flutter/plugin/common/MethodChannel$Result;Ljava/io/ByteArrayOutputStream;)V
    ...
    .line 34
    .line 35
    invoke-direct {p0, p1, p2}, Lr7/g;-><init>(Lio/flutter/plugin/common/MethodChannel$Result;I)V
...
.method private static synthetic q(ZLio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;Landroid/os/Handler;Landroid/os/Handler;)V
    ...
    .line 2
    .line 3
    invoke-static {p1, p2, p3}, Lr7/h;->j(Lio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;Landroid/os/Handler;)V
    ...
    .line 7
    :cond_0
    invoke-static {p3, p4, p1, p2}, Lr7/h;->t(Landroid/os/Handler;Landroid/os/Handler;Lio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;)V
...
.method private static synthetic r(ZLio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;Landroid/os/Handler;Landroid/os/Handler;)V
    ...
    .line 9
    invoke-direct/range {v0 .. v5}, Lr7/d;-><init>(ZLio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;Landroid/os/Handler;Landroid/os/Handler;)V

    .line 10
    .line 11
    .line 12
    invoke-static {v6}, Lr7/h;->u(Ljava/lang/Runnable;)V
...
.method private static t(Landroid/os/Handler;Landroid/os/Handler;Lio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;)V
    ...
    .line 12
    invoke-direct/range {v0 .. v5}, Lr7/b;-><init>(ZLio/flutter/embedding/android/FlutterView;Lio/flutter/plugin/common/MethodChannel$Result;Landroid/os/Handler;Landroid/os/Handler;)V
...
.method private static u(Ljava/lang/Runnable;)V
    ...
    .line 6
    .line 7
    invoke-direct {v1, p0}, Lr7/h$a;-><init>(Ljava/lang/Runnable;)V
