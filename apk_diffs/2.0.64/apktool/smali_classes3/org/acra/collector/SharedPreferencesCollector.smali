...
.method private collect(Landroid/content/Context;LNa/f;)Lorg/json/JSONObject;
    .locals 5
    ...
    .line 8
    invoke-virtual {p2}, LNa/f;->c()LMa/b;

    move-result-object v2

    invoke-virtual {v2}, LMa/b;->iterator()Ljava/util/Iterator;
    ...
    invoke-direct {p0, p2, v4}, Lorg/acra/collector/SharedPreferencesCollector;->filteredKey(LNa/f;Ljava/lang/String;)Z
...
.method private filteredKey(LNa/f;Ljava/lang/String;)Z
    .locals 1
    .param p1    # LNa/f;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 1
    invoke-virtual {p1}, LNa/f;->n()LMa/b;
...
.method collect(Lorg/acra/ReportField;Landroid/content/Context;LNa/f;LLa/b;Lorg/acra/data/a;)V
    ...
    invoke-direct {p0, p2, p3}, Lorg/acra/collector/SharedPreferencesCollector;->collect(Landroid/content/Context;LNa/f;)Lorg/json/JSONObject;
    ...
    invoke-direct {p4, p2, p3}, LSa/a;-><init>(Landroid/content/Context;LNa/f;)V

    invoke-virtual {p4}, LSa/a;->a()Landroid/content/SharedPreferences;
