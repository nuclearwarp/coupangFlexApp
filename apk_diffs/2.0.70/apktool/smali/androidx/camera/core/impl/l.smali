...
.method private static synthetic h(Ljava/util/concurrent/Executor;Lcom/google/common/util/concurrent/f;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;J)V
    ...
    .line 2
    .line 3
    invoke-direct {v0, p1, p2, p3, p4}, Lx/I;-><init>(Lcom/google/common/util/concurrent/f;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;J)V
...
.method private static synthetic j(Ljava/util/List;Ljava/util/concurrent/ScheduledExecutorService;Ljava/util/concurrent/Executor;JZLandroidx/concurrent/futures/CallbackToFutureAdapter$a;)Ljava/lang/Object;
    ...
    .line 1
    invoke-static {p0}, LB/f;->n(Ljava/util/Collection;)Lcom/google/common/util/concurrent/f;
    ...
    .line 12
    invoke-direct/range {v0 .. v5}, Lx/K;-><init>(Ljava/util/concurrent/Executor;Lcom/google/common/util/concurrent/f;Landroidx/concurrent/futures/CallbackToFutureAdapter$a;J)V
    ...
    .line 22
    .line 23
    invoke-direct {p3, p0}, Lx/L;-><init>(Lcom/google/common/util/concurrent/f;)V
    ...
    .line 33
    .line 34
    invoke-static {p0, p3, p2}, LB/f;->b(Lcom/google/common/util/concurrent/f;LB/c;Ljava/util/concurrent/Executor;)V
...
.method public static k(Ljava/util/Collection;ZJLjava/util/concurrent/Executor;Ljava/util/concurrent/ScheduledExecutorService;)Lcom/google/common/util/concurrent/f;
    ...
    .line 41
    invoke-direct/range {v0 .. v6}, Lx/J;-><init>(Ljava/util/List;Ljava/util/concurrent/ScheduledExecutorService;Ljava/util/concurrent/Executor;JZ)V
