...
# direct methods
.method constructor <init>(Lx/v;Landroid/util/Size;)V
    .locals 3
    .param p1    # Lx/v;
    ...
    .line 3
    .line 4
    iput-object p1, p0, Landroidx/camera/core/internal/a;->a:Lx/v;
    ...
    .line 25
    :cond_0
    invoke-direct {p0, p1}, Landroidx/camera/core/internal/a;->i(Lx/v;)Landroid/util/Rational;
    ...
    .line 49
    .line 50
    invoke-direct {v0, p1, p2}, Landroidx/camera/core/internal/b;-><init>(Lx/v;Landroid/util/Rational;)V
...
.method private c(Ljava/util/List;Landroidx/camera/core/resolutionselector/ResolutionSelector;I)Ljava/util/List;
    ...
    .line 15
    .line 16
    iget-object p1, p0, Landroidx/camera/core/internal/a;->a:Lx/v;

    .line 17
    .line 18
    invoke-interface {p1, p3}, Lx/v;->j(I)Ljava/util/List;
    ...
    .line 26
    .line 27
    invoke-direct {p1, v0}, Landroidx/camera/core/impl/utils/e;-><init>(Z)V
...
.method private e(Ljava/util/List;LI/a;I)Ljava/util/List;
    .locals 3
    .param p1    # Ljava/util/List;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 25
    .line 26
    invoke-interface {p2, v0, p3}, LI/a;->filter(Ljava/util/List;I)Ljava/util/List;
...
.method private i(Lx/v;)Landroid/util/Rational;
    .locals 2
    .param p1    # Lx/v;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 2
    .line 3
    invoke-interface {p1, v0}, Lx/v;->o(I)Ljava/util/List;
...
.method private j(ILandroidx/camera/core/impl/ImageOutputConfig;)Ljava/util/List;
    ...
    .line 2
    invoke-interface {p2, v0}, Landroidx/camera/core/impl/ImageOutputConfig;->l(Ljava/util/List;)Ljava/util/List;
...
.method private k(Landroidx/camera/core/impl/E;)Ljava/util/List;
    .locals 3
    ...
    .line 1
    invoke-interface {p1}, Landroidx/camera/core/impl/q;->p()I
    ...
    .line 27
    invoke-direct {p1, v2}, Landroidx/camera/core/impl/utils/e;-><init>(Z)V
...
.method static n(IZ)Landroid/util/Rational;
    ...
    .line 27
    .line 28
    invoke-static {p1, p0}, Lv/G;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method private p(Landroidx/camera/core/impl/E;)Ljava/util/List;
    .locals 7
    .param p1    # Landroidx/camera/core/impl/E;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 3
    .line 4
    invoke-interface {v0}, Landroidx/camera/core/impl/ImageOutputConfig;->m()Landroidx/camera/core/resolutionselector/ResolutionSelector;
    ...
    .line 8
    invoke-direct {p0, p1}, Landroidx/camera/core/internal/a;->k(Landroidx/camera/core/impl/E;)Ljava/util/List;
    ...
    .line 13
    invoke-interface {p1, v2}, Landroidx/camera/core/impl/E;->q(Z)Z
    ...
    .line 105
    :cond_4
    invoke-virtual {v0}, Landroidx/camera/core/resolutionselector/ResolutionSelector;->c()LI/a;
    ...
    .line 113
    invoke-direct {p0, v3, v0, p1}, Landroidx/camera/core/internal/a;->e(Ljava/util/List;LI/a;I)Ljava/util/List;
...
# virtual methods
.method m(Landroidx/camera/core/impl/E;)Ljava/util/List;
    .locals 3
    .param p1    # Landroidx/camera/core/impl/E;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 5
    invoke-interface {v0, v1}, Landroidx/camera/core/impl/ImageOutputConfig;->o(Ljava/util/List;)Ljava/util/List;
    ...
    .line 12
    :cond_0
    invoke-interface {v0, v1}, Landroidx/camera/core/impl/ImageOutputConfig;->G(Landroidx/camera/core/resolutionselector/ResolutionSelector;)Landroidx/camera/core/resolutionselector/ResolutionSelector;
    ...
    .line 24
    invoke-virtual {v0, v1, p1}, Landroidx/camera/core/internal/b;->f(Ljava/util/List;Landroidx/camera/core/impl/E;)Ljava/util/List;
    ...
    .line 29
    :cond_1
    invoke-direct {p0, p1}, Landroidx/camera/core/internal/a;->p(Landroidx/camera/core/impl/E;)Ljava/util/List;
