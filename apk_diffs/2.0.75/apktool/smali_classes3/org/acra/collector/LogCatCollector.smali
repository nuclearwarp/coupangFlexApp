...
.method private collectLogCat(LRa/f;Ljava/lang/String;)Ljava/lang/String;
    .locals 6
    .param p1    # LRa/f;
    ...
    .line 24
    :cond_0
    invoke-virtual {p1}, LRa/f;->q()LQa/b;
    ...
    .line 112
    invoke-interface {v1, v2, p2}, LUa/a;->c(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 120
    invoke-direct {p0, p1, p2, v1, v4}, Lorg/acra/collector/LogCatCollector;->streamToString(LRa/f;Ljava/io/InputStream;Lbb/h;I)Ljava/lang/String;
...
.method private streamToString(LRa/f;Ljava/io/InputStream;Lbb/h;I)Ljava/lang/String;
    .locals 1
    .param p1    # LRa/f;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 2
    .line 3
    invoke-direct {v0, p2}, Lbb/j;-><init>(Ljava/io/InputStream;)V

    .line 4
    .line 5
    .line 6
    invoke-virtual {v0, p3}, Lbb/j;->e(Lbb/h;)Lbb/j;
    ...
    .line 10
    invoke-virtual {p2, p4}, Lbb/j;->f(I)Lbb/j;
    ...
    .line 21
    .line 22
    invoke-virtual {p2, p1}, Lbb/j;->g(I)Lbb/j;

    .line 23
    .line 24
    .line 25
    :cond_0
    invoke-virtual {p2}, Lbb/j;->b()Ljava/lang/String;
...
# virtual methods
.method collect(Lorg/acra/ReportField;Landroid/content/Context;LRa/f;LPa/b;Lorg/acra/data/a;)V
    .locals 1
    ...
    :cond_2
    :goto_0
    invoke-direct {p0, p3, v0}, Lorg/acra/collector/LogCatCollector;->collectLogCat(LRa/f;Ljava/lang/String;)Ljava/lang/String;
...
.method shouldCollect(Landroid/content/Context;LRa/f;Lorg/acra/ReportField;LPa/b;)Z
    .locals 0
    ...
    .line 1
    invoke-super {p0, p1, p2, p3, p4}, Lorg/acra/collector/BaseReportFieldCollector;->shouldCollect(Landroid/content/Context;LRa/f;Lorg/acra/ReportField;LPa/b;)Z
    ...
    .line 8
    .line 9
    invoke-direct {p3, p1, p2}, LWa/a;-><init>(Landroid/content/Context;LRa/f;)V

    .line 10
    .line 11
    .line 12
    invoke-virtual {p3}, LWa/a;->a()Landroid/content/SharedPreferences;
