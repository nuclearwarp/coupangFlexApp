...
.method private collect(Landroid/content/Context;LRa/f;)Lorg/json/JSONObject;
    .locals 5
    ...
    .line 8
    invoke-virtual {p2}, LRa/f;->c()LQa/b;

    move-result-object v2

    invoke-virtual {v2}, LQa/b;->iterator()Ljava/util/Iterator;
    ...
    invoke-direct {p0, p2, v4}, Lorg/acra/collector/SharedPreferencesCollector;->filteredKey(LRa/f;Ljava/lang/String;)Z
...
.method private filteredKey(LRa/f;Ljava/lang/String;)Z
    .locals 1
    .param p1    # LRa/f;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 1
    invoke-virtual {p1}, LRa/f;->o()LQa/b;
    ...
    .line 5
    invoke-virtual {p1}, LQa/b;->iterator()Ljava/util/Iterator;
...
.method collect(Lorg/acra/ReportField;Landroid/content/Context;LRa/f;LPa/b;Lorg/acra/data/a;)V
    ...
    invoke-direct {p0, p2, p3}, Lorg/acra/collector/SharedPreferencesCollector;->collect(Landroid/content/Context;LRa/f;)Lorg/json/JSONObject;
    ...
    new-instance p4, LWa/a;

    invoke-direct {p4, p2, p3}, LWa/a;-><init>(Landroid/content/Context;LRa/f;)V

    invoke-virtual {p4}, LWa/a;->a()Landroid/content/SharedPreferences;
