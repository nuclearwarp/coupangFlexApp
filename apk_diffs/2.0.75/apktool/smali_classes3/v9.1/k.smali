...
# static fields
.field public static final a:Lv9/k;
...
# virtual methods
.method public a(Lx9/q;Ljava/lang/String;LU9/O;LU9/O;)LU9/G;
    .locals 1
    .param p1    # Lx9/q;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 28
    .line 29
    sget-object p1, LW9/j;->R:LW9/j;

    .line 30
    .line 31
    invoke-virtual {p3}, LU9/O;->toString()Ljava/lang/String;
    ...
    .line 35
    invoke-virtual {p4}, LU9/O;->toString()Ljava/lang/String;
    ...
    .line 43
    invoke-static {p1, p2}, LW9/k;->d(LW9/j;[Ljava/lang/String;)LW9/h;
    ...
    .line 48
    :cond_0
    sget-object p2, LA9/a;->g:Lkotlin/reflect/jvm/internal/impl/protobuf/h$f;
    ...
    .line 57
    .line 58
    invoke-direct {p1, p3, p4}, Lr9/h;-><init>(LU9/O;LU9/O;)V
    ...
    .line 62
    :cond_1
    invoke-static {p3, p4}, LU9/H;->d(LU9/O;LU9/O;)LU9/v0;
